Feature: Remove transaction item
  ...
  Scenario: A user removes a transaction
    ...
    And I should see the following transaction items table
      ...
      | 1/2/2013 | Kroger      | Groceries |      |   -35.00 | 4,929.00 |
  ...
  # This scenario fails because the use of transactions is the test suite interferes
  # with the transactions in the application
  ...
  #    |     Date | Description | Account   | Rec. |   Amount |  Balance |
  #    | 1/2/2013 | Kroger      | Groceries |      |   -35.00 | 4,929.00 |
  #    | 1/2/2013 | Kroger      | Groceries |  X   |   -36.00 | 4,964.00 |
