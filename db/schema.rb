...
ActiveRecord::Schema.define(version: 20151021155753) do
  ...
  create_table "accounts", force: true do |t|
    ...
    t.decimal  "children_cost",               default: 0.0, null: false
    t.decimal  "children_gains",              default: 0.0, null: false
    t.decimal  "children_value",              default: 0.0, null: false
  end
