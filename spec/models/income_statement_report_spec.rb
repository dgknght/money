...
describe IncomeStatementReport do
  ...
  let!(:salary_3) do
    TransactionManager.create(entity, transaction_date: '2013-02-01',
                                      description: 'The Factory',
                                      items_attributes: [
                                        {action: TransactionItem.credit, account_id: salary.id, amount: 3000},
                                        {action: TransactionItem.debit, account_id: checking.id, amount: 3000}
  ...
  let!(:salary_4) do
    TransactionManager.create(entity, transaction_date: '2013-02-15',
                                      description: 'The Factory',
                                      items_attributes: [
                                        {action: TransactionItem.credit, account_id: salary.id, amount: 3000},
                                        {action: TransactionItem.debit, account_id: checking.id, amount: 3000}
  ...
  let!(:gifts_1) do
    TransactionManager.create(entity, transaction_date: '2013-02-27',
                                      description: 'Mom',
                                      items_attributes: [
  ...
  let!(:groceries_1) do
    TransactionManager.create(entity, transaction_date: '2013-01-06',
                                      description: 'Kroger',
                                      items_attributes: [
  ...
  let!(:groceries_2) do
    TransactionManager.create(entity, transaction_date: '2013-01-13',
                                      description: 'Kroger',
                                      items_attributes: [
  ...
  let!(:groceries_3) do
    TransactionManager.create(entity, transaction_date: '2013-01-20',
                                      description: 'Kroger',
                                      items_attributes: [
                                        {action: TransactionItem.credit, account_id: credit_card.id, amount: 50},
                                        {action: TransactionItem.debit, account_id: groceries.id, amount: 50}
  ...
  let!(:groceries_4) do
    TransactionManager.create(entity, transaction_date: '2013-01-27',
                                      description: 'Kroger',
                                      items_attributes: [
                                        {action: TransactionItem.credit, account_id: credit_card.id, amount: 50},
                                        {action: TransactionItem.debit, account_id: groceries.id, amount: 50}
  ...
  let!(:groceries_5) do
    TransactionManager.create(entity, transaction_date: '2013-02-03',
                                      description: 'Kroger',
                                      items_attributes: [
                                        {action: TransactionItem.credit, account_id: credit_card.id, amount: 50},
                                        {action: TransactionItem.debit, account_id: groceries.id, amount: 50}
  ...
  let!(:groceries_6) do
    TransactionManager.create(entity, transaction_date: '2013-02-10',
                                      description: 'Kroger',
                                      items_attributes: [
                                        {action: TransactionItem.credit, account_id: credit_card.id, amount: 50},
                                        {action: TransactionItem.debit, account_id: groceries.id, amount: 50}
  ...
  let!(:groceries_7) do
    TransactionManager.create(entity, transaction_date: '2013-02-17',
                                      description: 'Kroger',
                                      items_attributes: [
                                        {action: TransactionItem.credit, account_id: credit_card.id, amount: 50},
                                        {action: TransactionItem.debit, account_id: groceries.id, amount: 50}
  ...
  let!(:groceries_8) do
    TransactionManager.create(entity, transaction_date: '2013-02-24',
                                      description: 'Kroger',
                                      items_attributes: [
                                        {action: TransactionItem.credit, account_id: credit_card.id, amount: 50},
                                        {action: TransactionItem.debit, account_id: groceries.id, amount: 50}
  ...
  let!(:credit_card_1) do
    TransactionManager.create(entity, transaction_date: '2013-01-4',
  ...
  let!(:credit_card_1) do
    TransactionManager.create(entity, transaction_date: '2013-02-4',
                                      description: 'Citibank',
                                      items_attributes: [
                                        {action: TransactionItem.credit, account_id: checking.id, amount: 100},
                                        {action: TransactionItem.debit, account_id: credit_card.id, amount: 100}
  ...
  let!(:mortgage_1) do
    TransactionManager.create(entity, transaction_date: '2013-01-2',
  ...
  let!(:mortgage_2) do
    TransactionManager.create(entity, transaction_date: '2013-02-2',
                                      description: 'Quicken Loans',
                                      items_attributes: [
                                        {action: TransactionItem.credit, account_id: checking.id, amount: 1000},
