...
describe BudgetMonitor do
  ...
  describe '#budget_amount' do
    it 'returns the amount budget for the period, prorated for the number of days that have passed' do
  ...
  describe '#current_amount' do
    ...
    it 'returns the amount spent so far this period' do
      Timecop.freeze(Time.parse('2015-02-14 12:00:00 CST')) do
  ...
  describe '#available_days' do
    it 'returns the total number of days in the period' do
      Timecop.freeze(Time.parse('2015-02-14 12:00:00 CST')) do
  ...
  describe '#past_days' do
    it 'returns the number of days in the period that have already past' do
      Timecop.freeze(Time.parse('2015-02-14 12:00:00 CST')) do
